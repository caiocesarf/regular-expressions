...
print("a)", check_family("HMmm", regex_a))    # true
print("a)", check_family("HMhh", regex_a))  # True
print("a)", check_family("HMhhm", regex_a))  # True
...
# mais novo homem.
regex_c = r"(HM|MH)(m+((m|h)*(h|m)*)h+)"
print("c)", check_family("HMmmhmmh", regex_c))    # True
...
regex_d = r"(HH|MM)((hm|mh))((m|h)+(h|m)+)((hm|mh))"
#regex_d = r"HH(hh|mm){2,}(hh|mm)"
print("d)", check_family("HHhmmmmh", regex_d)) # True
...
regex_e = r"(HH|MM)((hm)|(mh))(hm)*(mh)*"
print("e)", check_family("HHmhhm", regex_e)) # True
print("e)", check_family("HHhmhmhm", regex_e))  # False
